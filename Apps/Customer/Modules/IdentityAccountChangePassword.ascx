<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IdentityAccountChangePassword.ascx.cs" Inherits="StefanOlsen.Manager.Apps.Customer.Modules.IdentityAccountChangePassword" %>
