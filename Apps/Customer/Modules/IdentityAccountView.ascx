<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="IdentityAccountView.ascx.cs" Inherits="StefanOlsen.Manager.Apps.Customer.Modules.IdentityAccountView" %>
...
<table cellpadding="0" cellspacing="0" width="100%">
	<tr>
		<td style="padding: 7px">
			<mc2:BlockHeaderLight HeaderCssClass="ibn-toolbar-light" ID="bhl" runat="server" Title="<%$ Resources:Customer, Account %>"></mc2:BlockHeaderLight>
